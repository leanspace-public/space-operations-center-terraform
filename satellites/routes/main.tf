...
module "route_release_queue_configuration" {
  ...
  client_id_ccs_protocol_transformer     = var.client_id_ccsds_protocol_transformer
  ...
  client_secret_ccs_protocol_transformer = var.client_secret_ccsds_protocol_transformer
